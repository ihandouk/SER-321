...
import raft.ServerThreadThread;
...
public class Peer {
	...
	private ServerThreadThread serverThread;

	public Peer(BufferedReader bufReader, String username, ServerThreadThread serverThread) throws IOException {
	...
	public static void main(String[] args) throws Exception {
		...
		ServerThreadThread serverThread = new ServerThreadThread(args[1]);
		serverThread.start();
